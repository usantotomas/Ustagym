...
// proceso de envio de datos al web service
	...
	$valores->numIdentificacion = $documento; // parametro que viene desde datos_user.php  /numero de documento
...
//Validar la respuesta en el web service
	...
	if ($ConsultarContratoLaboralCARs->InfoRespuesta->ErrorCode == 'OK') { // si la respuesta del web service es 'Ok' procede a asignar el dato a la variable $estado_user

		$estado_user = $ConsultarContratoLaboralCARs->InfoContrato->estado;
